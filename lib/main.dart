...
class _CameraHomeState extends State<CameraHome> {
      ...
      builder: (_) => StatefulBuilder(builder: (ctx, setSheet) {
        return SafeArea(child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            const Text('NAOD PRO SETTINGS', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
  ...
  Widget _switch(String a, bool v, ValueChanged<bool> f) => SwitchListTile(
    title: Text(a), value: v, activeThumbColor: const Color(0xffffd400),
    onChanged: f);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(child: Stack(children: [
        ...
        if (focus != null) Positioned(
          left: focus!.dx-32, top: focus!.dy-32,
          child: Container(width:64,height:64,decoration:BoxDecoration(
            border: Border.all(color: const Color(0xffffd400),width:2), borderRadius: BorderRadius.circular(5)))),
        _top(),
  ...
  Widget _top() => Positioned(top:0,left:0,right:0,child: Container(
    ...
    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children:[
      ...
      _chip(quality,'4K'==quality),
      _chip('HDR',hdr),
      IconButton(onPressed:()=>setState(()=>grid=!grid),icon:Icon(Icons.grid_3x3,color:grid?const Color(0xffffd400):Colors.white)),
  ...
  Widget _chip(String t,bool active)=>Container(
    ...
    decoration:BoxDecoration(borderRadius:BorderRadius.circular(18),border:Border.all(
      color:active?const Color(0xffffd400):Colors.white54,width:active?2:1)),
    child:Text(t,style:TextStyle(fontWeight:FontWeight.w900,color:active?const Color(0xffffd400):Colors.white)));
  ...
  Widget _bottom() => Positioned(left:0,right:0,bottom:0,child:Container(
    ...
    child:Column(mainAxisSize:MainAxisSize.min,children:[
      Row(mainAxisAlignment:MainAxisAlignment.center,children:[
        ...['0.5','1.0','2.0','5.0'].map((z)=>Padding(padding:const EdgeInsets.symmetric(horizontal:10),
          child:Text(z,style:TextStyle(fontWeight:FontWeight.bold,color:
          z==zoom.toStringAsFixed(1)?const Color(0xffffd400):Colors.white))))
      ]),
      Slider(value:zoom,min:minZoom,max:maxZoom,onChanged:(v){setState(()=>zoom=v);c!.setZoomLevel(v);}),
      Row(children:[
      ...
      Row(mainAxisAlignment:MainAxisAlignment.spaceEvenly,children:[
        IconButton(onPressed:()=>_msg('Open your Photos/Gallery to view Naod HD Camera media'),
